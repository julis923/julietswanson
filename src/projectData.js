...
import railtimeUserStory from "./assets/railtimeUserStory.png";
//import barebitesLofi2 from './assets/barebites-lofi-2.png';
import railtimeUserFlow from "./assets/railtimeUserFlow.png";
import railtimeFinal from "./assets/railtimeFinal.png";
import railtimeHifi from "./assets/railtimeHifi.png";
import barebitesHifi1 from "./assets/barebites-hifi-1.png";
import barebitesBranding from "./assets/barebites-branding.png";
import railTimeMain from "./assets/railtimeMain.png";
...
import railtimeLofi from "./assets/railtimeLofi.png";
...
const projects = [
  ...
  },
  {
    ...
    bannerBtns: [
      ...
      {
        text: "View prototype",
        link: "https://www.figma.com/proto/JeuuUI5NRKJz277JDmTeuQ/Railtime-v2?page-id=0%3A1&type=design&node-id=1-2&viewport=406%2C314%2C0.12&t=ldkVssUCZtGLWPn1-1&scaling=min-zoom&starting-point-node-id=1%3A2&mode=design",
        classes: "external-link",
      },
    ],
    sections: [
        ...
        subsections: [
          {
            title: "",
            text: [
              "As a frequent user of Bay Area Rapid Transit, I have always struggled to balance keeping track of my route with immersing myself in an activity during long commutes. Others have often agreed, saying that they wish they could concentrate on work or reading while on public transit, but are too afraid that they will miss their stop.",
              "I gave myself one week to research, design, and brand an app that allows BART users to quickly and easily set an alert for their stop on public transportation, plus save alerts to make future trips a breeze. In doing so, users can maximize their time on public transit by engaging in activities without worrying about their route.",
            ],
          },
          {
            title: "My role",
          ...
          {
            title: "Duration",
            text: ["Nov 2021 (1 week sprint)"],
          },
          {
            title: "Tools & technologies",
            text: ["Figma, Adobe Photoshop"],
          },
        ],
      },
      {
        ...
        subsections: [
          {
            title: "",
            text: [
              "Public transit riders in the SF Bay Area can't take full advantage of their time during commutes - according to a survey I conducted, 70% of commuters indicated that they struggle to engage in activities like work or reading while commuting due to fear of missing their stop.",
              "How can an app save commuters time and energy by alerting them when they are approaching their stop?",
            ],
          },
        ],
      },
        ...
        subsections: [
          {
            ...
            text: [
              "I aimed to target the following user concerns in my design, which I determined to be the most important areas of focus after surveying a number of transit users:",
              "1. Intuitive process for choosing the transit route and setting the alert",
              "2. Ability to save frequented routes",
              "3. Ability to optimize alert settings to user’s preference (vibrations, timing, etc.)",
              "4. Welcoming and modern interface",
            ],
            image: railtimeUserStory,
            imageAlt: "user stories",
          },
          {
            title: "User flow mapping",
            text: [
              "In order to build the most intuitive process for setting an alert, I used a user flow map method to outline the process of creating a route. I identified the main steps as logging in, selecting a train route, selecting a stop on that route, and selecting alert preferences.",
            ],
            image: railtimeUserFlow,
            imageAlt: "user flow map",
          },
          {
            title: "Wireframing",
            text: [
              "Next, I used my user flow map and the primary user goals from my research to determine the framework of the app. The homepage displays current alerts as well as options to create a new alert, update preferences, and add saved routes. Each of these processes is translated into an intuitive workflow.",
            ],
            image: railtimeLofi,
            imageAlt: "Low-fidelity wireframes",
          },
          {
            title: "Prototyping and branding",
            text: [
              ...
              "I shared the prototype with some of the users who I had originally surveyed, and made small tweaks and iterations based on their feedback until the app was satisfactory.",
            ],
            image: railtimeHifi,
            imageAlt: "High-fidelity mockups",
          },
        ],
      },
      {
        ...
        subsections: [
          {
            title: "",
            text: [
              "This project was a successful implementation of the design process in a quick one week sprint. I began the week by surveying users and identifying and empathizing with their pain points.",
              "After defining the problem, I used user flows and wireframes to translate the solution into interactive interfaces. Then, I designed a logo and selected colorways and typography to solidify a modern and streamlined visual identity.",
              "The final step was creating, prototyping, and testing high-fidelity mockups on Figma.",
            ],
            image: railtimeFinal,
            imageAlt: "Final screens",
          },
        ],
      },
    ],
