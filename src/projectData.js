...
import procotoProposal from './assets/procotoProposal.mov';
import procotoDemo from './assets/procotoDemo.mov';
import procotoProposalPDF from './assets/procotoProposalPDF.pdf';

const projects = [
  {
    title: 'Procoto (SaaS) Web App',
    description:
      'I owned the entire frontend development and design of Procoto, a procurement software aimed at modernizing sourcing and purchasing for businesses.',
    mainImg: {
      type: 'video',
      content: procotoDemo,
      alt: null,
    ...
    types: [
      ...
      'API integrations',
      'CI/CD',
      'AWS authentication & storage',
      'UX/UI',
      'Custom UI library',
    ],
    tags: ['front-end', 'ux/ui', 'branding', 'featured', 'design systems'],
    hashlink: 'procotoProposal',
    viewCode: [null, 'Code Private', null],
    viewLive: [true, 'View app', 'https://app.procoto.com/'],
    project: [
      'Procoto is procurement software aimed at modernizing sourcing and purchasing for businesses. Among its core values is developing highly intuitive and user-friendly interfaces to make sourcing fun, simple, and beautiful.',
      "As a Founding Product Designer and Engineer at Procoto, I built the frontend application from the ground up, including a CI/CD pipeline, comprehensive test coverage, a reusable custom UI library, API integrations, custom React hooks, and more.",
      "Kindly note that all designs and code are proprietary. However, you can check out the live app!"
    ],
    details: ['React', 'Redux', 'Sass', 'AWS Amplify, Cognito + S3', 'Cypress', 'Jest', 'Figma'],
  },
  {
    title: 'Procoto (SaaS) Branding & UX/UI Proposal',
    description:
      'A rebranding and design proposal for an early-stage, dynamic SaaS startup. Intended to serve as an initial style guide for stakeholders, marketers and developers, the proposal has since been adopted and developed into a cohesive design system and integrated into a scalable UI library.',
    mainImg: {
      type: 'video',
      content: procotoProposal,
      alt: null,
    },
    types: ['UX/UI', 'Branding', 'Figma'],
    tags: [
      'full-stack',
      'front-end',
      'ux/ui',
    ...
    hashlink: 'procotoProposal',
    viewCode: [true, 'View PDF', procotoProposalPDF],
    project: [
      'Procoto is procurement software aimed at modernizing sourcing and purchasing for businesses. Among its core values is developing highly intuitive and user-friendly interfaces to make sourcing fun, simple, and beautiful.',
      "As a Founding Product Designer and Engineer at Procoto, I solidified the company's distinctive brand and identity. Among my earliest endeavors was the creation of comprehensive style guidelines, meticulously crafted to embody Procoto's vision and essence. To provide a vivid glimpse into the potential of these guidelines, I thoughtfully incorporated hi-fidelity mockups, seamlessly integrating the proposed design systems into the application's interfaces. This deliberate approach allowed stakeholders and fellow team members to envision how these guidelines could seamlessly evolve into a highly adaptable and scalable UI library.",
    ],
    projectProcess: [
      {
        step: 'Determining fonts, colorways, and iconography',
        description: [
          'I used pre-existing brand assets to develop a more comprehensive guideline that fit the company ethos and would serve as strong building blocks for complex interfaces. I chose colors and fonts that, when paired, would allow for easy maintenance of web readability and accessibility.',
        ],
        images: [],
      },
      {
        step: 'Designing hi-fidelity mockups',
        description: [
          'In order to provide real-world implementation examples for team members and stakeholders, I used Figma to build several hi-fidelity mockups of the application. The mockups showcased how the design guidelines could be developed into a design system of reusable, scalable components.',
        ],
        images: [],
        link: null,
      },
      {
        step: 'Presenting to stakeholders',
        description: [
          'I shared the proposal with stakeholders, highlighting its alignment with company values and its ability to grow the company through marketing, brand identity, and user experience',
          'The proposal was extremely well-recieved, and after some further iterations it was implemented and developed into a custom UI library.',
        ],
        images: [],
      },
    ],
    details: ['Built with Microsoft PowerPoint', 'Mockups designed on Figma'],
  },
  {
    title: 'myStyler App',
    description:
      'A full stack single page application which generates unique, professional resumes and offers a live preview feature. Resumes are customizable and scale text responsively to fit user input. Created with React, Node.js/Express, and MongoDB + AWS S3.',
    mainImg: {
      type: 'video',
      content: myStylerVid,
      alt: null,
    ...
    tags: ['full-stack', 'front-end', 'ux/ui', 'branding'],
    hashlink: 'myStyler',
    ...
    projectProcess: [
      ...
      },
      {
        ...
        images: [
          { content: resumes1, alt: 'resume designs' },
          { content: resumes2, alt: 'resume designs' },
          { content: resumes3, alt: 'resume designs' },
        ],
      },
      {
  ...
  },
  {
    ...
    description:
      "I was contracted to complete the UX/UI for a tutoring company's new, rebranded website. I developed the final web designs on Figma in accordance with branding and then built out the front end with the project supervisor.",
    mainImg: {
      type: 'video',
  ...
  },
  {
    title: 'ICSI Website',
    description:
      'A professional website designed for ICSI, a New York-based construction company. After completing the designs (as an independently contracted UX/UI designer), I assisted in building the website with Next.js and Wordpress Headless CMS.',
    mainImg: {
      type: 'video',
      content: icsiVid,
      alt: null,
  ...
  },
  {
    ...
    description:
      'A branding + landing page design concept for a fictional snackbar company.',
    mainImg: {
      type: 'video',
    ...
    projectProcess: [
      {
        ...
        images: [
          { content: barebitesLofi2, alt: 'low fidelity mockup' },
          { content: barebitesLofi1, alt: 'low fidelity mockup' },
        ],
      },
      {
  ...
  },
  {
    ...
    viewCode: [
      true,
      'View Hi-Fi Mockup',
      'https://www.figma.com/file/xevGXYMG7yjFMMhTxbnv6F/Embue-Landing?node-id=32%3A222',
    ],
    viewLive: [false, 'Site in Development'],
    viewDemo: [false],
    project: [
